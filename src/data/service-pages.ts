...
export const servicePages: Record<string, ServicePageContent> = {
  'individual-therapy': {
    ...
    description: 'Individual counseling with Avery Morgan, LPC, for adults seeking thoughtful, whole-person support in Richmond, Virginia.',
    ...
    approach: ['Avery may draw from Internal Family Systems concepts, somatic awareness, mindfulness, and other counseling tools depending on the focus of the work.', 'Sessions may include understanding why a response developed, recognizing what keeps it going, and exploring changes that could be useful in daily life.'],
    wholePersonTitle: 'Attention to mind and body',
    wholePerson: ['Thoughts and emotions often have a physical dimension. Avery may invite awareness of tension, breath, energy, or other body cues as useful information, always at a pace that respects your comfort.'],
  ...
  'trauma-ptsd': {
    title: 'Trauma & PTSD Therapy in Richmond, Virginia',
    description: 'Compassionate trauma and PTSD counseling with Avery Morgan, LPC, at Common Ground Therapy in Richmond, Virginia.',
    ...
    approach: ['Early work may focus on understanding current reactions, strengthening a sense of stability, and identifying what helps you stay connected to the present.', 'Depending on the situation, Avery may incorporate Internal Family Systems concepts, mindfulness, or somatic awareness. The pace can be adjusted as the work develops.'],
    related: [],
    approachLinks: [
    ...
    description: 'Individual counseling for anxiety, worry, stress, and overwhelm with Avery Morgan, LPC, in Richmond, Virginia.',
  ...
  'grief-loss': {
    ...
    description: 'Thoughtful individual counseling for grief and significant loss at Common Ground Therapy in Richmond, Virginia.',
  ...
  'depression-emotional-disconnection': {
    title: 'Depression & Disconnection | Richmond, VA',
    description: 'Counseling for low mood, emotional disconnection, and feeling stuck with Avery Morgan, LPC, in Richmond, Virginia.',
    ...
    approach: ['Avery may help you look at patterns connected with withdrawal, self-criticism, exhaustion, or emotional shutdown and identify manageable ways to reconnect with what matters to you.', 'Counseling may also include attention to physical cues or protective responses. The goal is not to force positive thinking, but to understand what is happening and consider realistic next steps.'],
    related: [{ slug: 'individual-therapy', label: 'Learn more about individual therapy' }],
    approachLinks: [
      { href: '/approaches/', label: 'Explore Avery’s therapy approaches' },
    ],
  },
  'chronic-pain-chronic-illness': {
    title: 'Chronic Pain & Illness Counseling | Richmond, VA',
    description: 'Counseling for adults living with chronic pain or illness, with support for grief, adjustment, identity, stress, and relationships in Richmond, Virginia.',
  ...
  'life-transitions': {
    ...
    description: 'Individual counseling for major changes in roles, identity, work, family, and relationships in Richmond, Virginia.',
  ...
  'relationship-concerns': {
    ...
    description: 'Individual counseling for relationship patterns, communication, boundaries, and conflict with Avery Morgan, LPC, in Richmond, Virginia.',
    ...
    lead: ['You may be struggling in a current relationship, recovering from one that ended, or noticing similar difficulties across different relationships. Individual therapy offers space to examine your own experience without another person participating.', 'This service is individual counseling related to relationships. Avery is not offering couples therapy through this service.'],
  ...
  'self-esteem-personal-growth': {
    title: 'Self-Esteem & Growth | Richmond, VA',
    description: 'Counseling for self-esteem, values, boundaries, confidence, and personal growth in Richmond, Virginia.',
